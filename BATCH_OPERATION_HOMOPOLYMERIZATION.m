...
%BATCH_OPERATION_HOMOPOLYMERIZATION.m: semi-batch model in batch operation 
%   with BMA only.
...
SAVENAME = 'BATCH_OPERATION_HOMOPOLYMERIZATION';

%% 1. load system properties:
disp('1. lLad system properties')
